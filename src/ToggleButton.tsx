...
let styles = tv({
  ...
  variants: {
    isSelected: {
      false:
        "pressed:bg-neutral-200 dark:pressed:bg-neutral-500 bg-neutral-50 text-neutral-800 hover:bg-neutral-100 dark:bg-neutral-700 dark:text-neutral-100 dark:hover:bg-neutral-600 forced-colors:bg-[ButtonFace]! forced-colors:text-[ButtonText]!",
      true: "pressed:bg-neutral-900 dark:pressed:bg-neutral-100 bg-neutral-700 text-white hover:bg-neutral-800 dark:bg-neutral-300 dark:text-black dark:hover:bg-neutral-200 forced-colors:bg-[Highlight]! forced-colors:text-[HighlightText]!"
    },
    isDisabled: {
