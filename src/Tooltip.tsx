...
const styles = tv({
  base: "group/tooltip box-border rounded-md bg-foreground px-2.5 py-1 text-xs text-background shadow-md ring-1 ring-foreground/10 will-change-transform",
  variants: {
    isEntering: {
    ...
    >
      <OverlayArrow>
        <svg
          ...
          height={8}
          viewBox="0 0 8 8"
          className="group/tooltip-placement-bottom:rotate-180 group/tooltip-placement-left:-rotate-90 group/tooltip-placement-right:rotate-90 block fill-foreground forced-colors:fill-[Canvas] forced-colors:stroke-[ButtonBorder]"
        >
